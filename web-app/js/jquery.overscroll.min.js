...
o.abs(b.scrollDelta);b.wheelDelta=o.abs(b.wheelDelta);a.removeOverscroll();a.data(c.removerKey,c.remover(a,d));d.target=a.css({position:"aboslute",overflow:"hidden",cursor:b.cursor}).bind(c.events.wheel,d,c.wheel).bind(c.events.start,d,c.start).bind(c.events.end,d,c.stop).bind(c.events.ignored,false);if(b.showThumbs){d.thumbs={};if(d.sizing.container.scrollWidth>0&&b.direction!=="vertical"){d.thumbs.horizontal=f(c.div).css(c.getThumbCss(d.sizing.thumbs.horizontal)).css({opacity:b.persistThumbs?c.constants.thumbOpacity:
0});a.prepend(d.thumbs.horizontal)}if(d.sizing.container.scrollHeight>0&&b.direction!=="horizontal"){d.thumbs.vertical=f(c.div).css(c.getThumbCss(d.sizing.thumbs.vertical)).css({opacity:b.persistThumbs?c.constants.thumbOpacity:0});a.prepend(d.thumbs.vertical)}}b.scrollLeft&&a.scrollLeft(b.scrollLeft);b.scrollTop&&a.scrollTop(b.scrollTop);c.moveThumbs(d,a.scrollLeft(),a.scrollTop())},remover:function(a,b){return function(){a.removeAttr("style").removeData(c.removerKey).unbind(c.events.wheel,c.wheel).unbind(c.events.start,
b,c.start).unbind(c.events.end,b,c.stop).unbind(c.events.ignored,false);if(b.thumbs){b.thumbs.horizontal&&b.thumbs.horizontal.remove();b.thumbs.vertical&&b.thumbs.vertical.remove()}}},triggerEvent:function(){},toggleThumbs:function(a,b){if(a.thumbs&&!a.options.persistThumbs)if(b){a.thumbs.vertical&&a.thumbs.vertical.stop(true,true).fadeTo("fast",c.constants.thumbOpacity);a.thumbs.horizontal&&a.thumbs.horizontal.stop(true,true).fadeTo("fast",c.constants.thumbOpacity)}else{a.thumbs.vertical&&a.thumbs.vertical.fadeTo("fast",
0);a.thumbs.horizontal&&a.thumbs.horizontal.fadeTo("fast",0)}},setPosition:function(a,b,d){b.x=a.pageX;b.y=a.pageY;b.time=c.time();b.index=d;return b},wheel:function(a,b){var d=a.data;a.preventDefault();c.clearInterval(d.target);if(a.wheelDelta)b=a.wheelDelta/(i.opera?-120:120);if(a.detail)b=-a.detail/3;if(!d.wheelCapture){d.wheelCapture={timeout:null};c.toggleThumbs(d,true);d.target.stop(true,d.flags.dragging=true)}b*=d.options.wheelDelta;if(d.options.wheelDirection==="horizontal")this.scrollLeft-=
...
b+a.thumbs.vertical.left;h=d*(1+a.container.height/a.container.scrollHeight);e.vertical.css("margin",h+"px 0 0 "+g+"px")}}},start:function(a){var b=a.data,d=b.target,e=b.flags;c.clearInterval(b.target);b.startTarget=f(a.target);if(!b.startTarget.is(b.options.cancelOn)){c.normalizeEvent(a);e.dragging=e.dragged=false;d.bind(c.events.drag,b,c.drag).stop(true,true);b.position=c.setPosition(a,{});b.capture=c.setPosition(a,{},2);c.triggerEvent("dragstart",b)}},drag:function(a){var b=a.data,d=b.flags;c.normalizeEvent(a);
d.dragged||c.toggleThumbs(b,true);d.dragged=true;if(b.options.direction!=="vertical")this.scrollLeft-=a.pageX-b.position.x;if(b.options.direction!=="horizontal")this.scrollTop-=a.pageY-b.position.y;c.moveThumbs(b,this.scrollLeft,this.scrollTop);c.setPosition(a,b.position);if(--b.capture.index<=0){d.dragging=true;c.setPosition(a,b.capture,c.constants.captureThreshold)}},normalizeEvent:function(a){var b;b=a.originalEvent;if(b.changedTouches){b=b.changedTouches;a.pageX=b.pageX;a.pageY=b.pageY}},time:function(){return(new Date).getTime()},
deferClick:function(a){var b=a.data("events");if(b&&b.click&&b.click.length){b=b.click.slice();a.unbind("click").one("click",function(d){d.preventDefault();f.each(b,function(e,g){a.click(g)})})}},stop:function(a){var b=a.data,d=b.target,e=b.flags;if(b.position){d.unbind(c.events.drag,c.drag);c.triggerEvent("dragend",b);e.dragging?c.drift(this,a,function(){c.toggleThumbs(b,e.dragging=false)}):c.toggleThumbs(b,false);if(e.dragged&&f(a.target).is(b.startTarget)){c.deferClick(b.startTarget);b.startTarget=
e.dragged=null}b.capture=b.position=undefined}},clearInterval:function(a){a=f(a);var b=a.data("overscroll-interval");b&&i.clearInterval(b);a.data("overscroll-interval",null)},setInterval:function(a,b){c.clearInterval(a);f(a).data("overscroll-interval",b)},drift:function(a,b,d){var e=b.data,g,h,j,k,l=a.scrollLeft,m=a.scrollTop,p=c.constants.driftDecay;if(c.time()-e.capture.time>c.constants.driftTimeout)return d.call(null,e);c.normalizeEvent(b);g=e.options.scrollDelta*(b.pageX-e.capture.x);h=e.options.scrollDelta*
(b.pageY-e.capture.y);j=g/c.constants.driftSequences;k=h/c.constants.driftSequences;if(e.options.direction!=="vertical")l-=g;if(e.options.direction!=="horizontal")m-=h;c.triggerEvent("driftstart",b.data);c.setInterval(a,i.setInterval(function(){var n=true;if(k>1&&a.scrollTop>m||k<-1&&a.scrollTop<m){n=false;a.scrollTop-=k;k/=p}if(j>1&&a.scrollLeft>l||j<-1&&a.scrollLeft<l){n=false;a.scrollLeft-=j;j/=p}c.moveThumbs(e,a.scrollLeft,a.scrollTop);if(n){c.clearInterval(a);c.triggerEvent("driftend",e);d.call(null,
